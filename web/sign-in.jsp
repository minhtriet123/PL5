                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="signin-inner my-3 my-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Tài khoản đăng nhập</h1>
                            </div>
                            <form action="CheckDangNhap" method="POST" class="mt-4">
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    <label for="email">Tên đăng nhập</label>
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1"><span class="fas fa-envelope"></span></span>
                                        <input type="" class="form-control" placeholder="example" id="email" autofocus required name="username">
                                    </div>  
                                </div>
                                <!-- End of Form -->
                            ...
                            <div class="mt-3 mb-4 text-center">
                                <span class="font-weight-normal">Hoặc đăng nhập với</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="font-weight-normal">
                                    ...
                                    <a href="./DangkyControl" class="font-weight-bold">Đăng ký</a>
                                </span>
                            </div>
                        </div>
                    </div>
